moment.updateLocale("zh-cn", {
  ...
  function () {
    ...
    (second = 1e3),
      ...
      (formats = {
        seconds: { short: " Sec", long: " Second" },
        minutes: { short: " Min", long: " Minute" },
        hours: { short: " Hr", long: " Hour" },
        ...
        return (
          (twitterFormat = function (format) {
            ...
            if (
              ...
              if ("long" !== format) return this.format("MMM. DD. YYYY，HH:mm");
              if (!(diff < week))
                return this.year(), year, this.format("MMM. DD. YYYY，HH:mm");
              unit = "days";
            }
            return (
              (num && unit) || (num = moment.duration(diff)[unit]()),
              (unitStr = unit = formats[unit][format]),
              num + (unitStr += "long" === format && num > 1 ? "s ago" : " ago")
            );
          }),
